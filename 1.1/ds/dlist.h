...
void delete_dlist(dlist** l, const void* item, size_t sz);
bool empty_dlist(const dlist* l);
void* head_dlist(const dlist* l);
void init_dlist(dlist** l);
void insert_dlist(dlist** l, const void* item, size_t sz);
void print_dlist(const dlist* l, void (*print_item)(const void* item));
const dlist* search_dlist(const dlist* l, const void* item, size_t sz);
